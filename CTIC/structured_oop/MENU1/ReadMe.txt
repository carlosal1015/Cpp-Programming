...
El Asistente para aplicaciones ha creado esta aplicación MENU1.
...
constituyen su aplicación MENU1.
...
MENU1Dlg.h, MENU1Dlg.cpp – el cuadro de diálogo
    Estos archivos contienen su clase CMENU1Dlg.  Esta clase define 
    el comportamiento del cuadro de diálogo principal de su aplicación. La 
    plantilla del cuadro de diálogo está en MENU1.rc, que puede 
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado MENU1.pch y un archivo de 
