...
double Suma::Raiz(){
	if(n2>0)
		return(powf(n1,1.0/n2));
	else{
		cout<<"Sin Solucion para la raiz "<<endl;
		system("pause");
	exit(0);}
}
...
void main(){
	float m1,m2;Suma S1;Suma S2(7,13);
	...
	cout<<S1.OptCociente()<<endl
		<<"La raiz de valores inicializados "<<S1.Raiz()<<'\n'<<'\n'
		<<"La suma con valores inicializados desde el main "<<S2.OptSuma()<<endl
		<<"El cociente con valores desde el main "<<S2.OptCociente()<<endl
		<<"La raiz con valores desde el main "<<S2.Raiz()<<endl<<endl;
	cout<<"Ingrese operando1= ";cin>>m1;
	cout<<"ingrese operando2= ";cin>>m2;
	Suma S3(m1,m2);
	cout<<"La suma con valores desde teclado "<<S3.OptSuma()<<endl
		<<"El cociente con valores desde teclado "<<S3.OptCociente()<<endl
		<<"La raiz con valores desde teclado= "<<S3.Raiz()<<endl;
	system("pause");
}
