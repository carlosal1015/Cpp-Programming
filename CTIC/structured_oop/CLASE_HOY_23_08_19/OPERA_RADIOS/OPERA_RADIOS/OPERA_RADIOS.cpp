...
// OPERA_RADIOS.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(COPERA_RADIOSApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de COPERA_RADIOSApp

COPERA_RADIOSApp::COPERA_RADIOSApp()
{
...
// El único objeto COPERA_RADIOSApp

COPERA_RADIOSApp theApp;


// Inicialización de COPERA_RADIOSApp

BOOL COPERA_RADIOSApp::InitInstance()
{
