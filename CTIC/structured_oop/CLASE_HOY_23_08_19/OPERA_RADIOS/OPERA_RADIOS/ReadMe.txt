================================================================================
    ...
    proyectoOPERA_RADIOS
================================================================================

El Asistente para aplicaciones ha creado esta aplicación OPERA_RADIOS.
...
constituyen su aplicación OPERA_RADIOS.

OPERA_RADIOS.vcxproj
...
OPERA_RADIOS.cpp
    ...
    de la aplicación COPERA_RADIOSApp.
...
OPERA_RADIOSDlg.h, OPERA_RADIOSDlg.cpp – el cuadro de diálogo
    Estos archivos contienen su clase COPERA_RADIOSDlg.  Esta clase define 
    el comportamiento del cuadro de diálogo principal de su aplicación. La 
    plantilla del cuadro de diálogo está en OPERA_RADIOS.rc, que puede 
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado OPERA_RADIOS.pch y un archivo de 
