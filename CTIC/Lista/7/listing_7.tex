...
\begin{parts}
	\part Todo mensaje debe tener sus letras en mayúsculas.
	\part Reemplazar cada letra por la que sigue según el abecedario excepto la 'Z' que deberá reemplazar con la letra 'A'.
	\part Reemplazar cada dígito encontrado por el que le precede según su orden excepto el '0'que deberá reemplazarse por el '9'.
\end{parts}
