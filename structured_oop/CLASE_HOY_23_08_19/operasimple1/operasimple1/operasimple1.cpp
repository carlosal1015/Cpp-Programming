...
// operasimple1.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(Coperasimple1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de Coperasimple1App

Coperasimple1App::Coperasimple1App()
{
...
// El único objeto Coperasimple1App

Coperasimple1App theApp;


// Inicialización de Coperasimple1App

BOOL Coperasimple1App::InitInstance()
{
