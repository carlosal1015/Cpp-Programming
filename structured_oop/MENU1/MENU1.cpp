...
// MENU1.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMENU1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMENU1App
...
// El único objeto CMENU1App

CMENU1App theApp;


// Inicialización de CMENU1App

BOOL CMENU1App::InitInstance()
{
